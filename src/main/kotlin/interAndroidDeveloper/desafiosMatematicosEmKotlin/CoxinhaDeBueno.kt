...
mas nunca conseguiram entrar para o livro dos recordes, o Guinness Book. Para isso,
o restaurante precisa preencher informações sobre a competição,
...
o número médio de coxinhas consumidas pelos participantes.
...
fun main() {
    ...
    val h: Int = entrada.nextInt()
    val p: Int = entrada.nextInt()
